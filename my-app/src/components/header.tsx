                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <a className="nav-link" href="/App"><img src={quizicon} alt="QUIZ" style={{ width:"26px" }} /> QUIZ </a>

                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="/AppDrag"><img src={handdrag} alt="DRAG" style={{ width: "26px" }} /> DRAG </a>
